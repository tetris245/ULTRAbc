		...
		PreferenceSubscreenResetExit = function () {
            ...
            PreferenceSubscreenUBCBackgroundsLoad = function() {
                ...
                addMenuCheckbox(64, 64, "移除角色信息中的背景按钮：", "noifbuttons",
                    "如果您检查此设置，UBC 将不会在角色信息屏幕中显示背景按钮。但是，您当前的设置将保持活动状态。重要说明：如果您想使用 Likokisu 的工具来更改此屏幕的背景，您需要先点击默认背景按钮，然后再检查此选项。", false, 200
                );
                ...
                addMenuCheckbox(64, 64, "移除衣柜中的背景按钮：", "nowrbuttons",
                    "如果您检查此设置，UBC 将不会在衣柜中显示背景按钮。但是，您当前的设置将保持活动状态。重要说明：如果您想使用 Likokisu 的工具来更改此屏幕的背景，您需要先点击默认背景按钮，然后再检查此选项。", false, 200
                );
            }
