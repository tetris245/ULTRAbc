...
* Added support for attempt emotes in whispers: the format must be *%(percentage) (action), percentage (between 0 and 100) is optional (default is 50) and must be after % (not before).
  - Note: If you want to switch to normal emotes, use the /attempt BC command.
