...
* New option in GUI - Visual to get a tint effect on  most backgrounds in the Bondage. Note: when combined with the concderned color in Themed, you will get a different tint effect, as both colors are "merged"!
