...
1. Download the ULTRAbc-version5.2.1.zip file on the Releases page
...
* Harmonised the UBC variables inside and outside the GUI (it does not include the Moaner variables)
