...
* New commands:
  - cardesk (desk) to set a specific desk as default desk for the Bondage Club Card Game
  - cardfame (fame) to set the fame level (between 200 and 1000) for the high fame mode of the Club Card Game
