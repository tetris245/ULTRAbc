...
* New commands:
  - roomsize (players) to set the maximum players per room in Chat Search for normal and hybrid rooms (players between 2 and 20)
  - roomtype (type) to set the room type you want so see in Chat Search (type 0 = all types, 1 = normal rooms, 2 = hybrid rooms, 3 = map rooms)
